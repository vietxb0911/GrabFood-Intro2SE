...
public class MainCustomerActivity_ extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.user_homepage_fragment);
    ...
    void buildRecycleView(){
        ...
        categoryAdapter.setOnItemClickListener(new CategoryAdapter.OnItemClickListener() {
            ...
            public void onItemClick(int position) {
                ...
                Intent intent = new Intent(MainCustomerActivity_.this, Activity_restaurant_info.class);
